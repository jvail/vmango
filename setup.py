...
# * name is the full name (e.g., VPlants.mangosim) whereas pkg_name is only 'mangosim'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['mangosim = vplants.mangosim_wralea' if has_project else 'mangosim = mangosim_wralea' ],
        #'console_scripts': [
