...
# Ce script nous a permis d'ajuster les distributions sur le nombre de feuilles (secondaire car on le d?duit de la longueur des UCs)
...
# On cherche les UCs ou il y a eu trop de feuilles chut?es 
par(mfrow=c(1,2))
...
# On cherche les UCs avec des longueurs tr?s ?loign?es des autres
...
# pour axe_port, NA correspond ? une Branche porteuse
porteuses=Tayllamin[Tayllamin$NumNdRam==7,]
port_apic=porteuses[porteuses$TypAxePo=="T",]
port_lat=porteuses[porteuses$TypAxePo=="R",]

# S?paration des arbres et des types
# NumNdRam = 0 : UC en position apicale, 0 < NumNdRam < 7 : UC en position lat?rale, NumNdRam = 7 : UC porteuse
...
# S?paration des UCs en fonction de leur type
# Pas de s?paration en fonction des arbres car pas assez de valeurs
...
# Histogrammes des UCs en position lat?rale pour chaque arbre et en global
par(mfrow=c(2,3))
...
#title("Nombre de feuilles issues d'UCs en position lat?rale",outer=TRUE,line=-1)
...
##### Histogrammes pour voir le lien entre position des UCs m?res et nbr de feuilles
...
# Histogramme 4 cas (apicale / lat?rale, pour UC et UC m?re)
x=2:23
par(mfrow=c(2,2))
hist(TA_apic_port_apic$NbFeu,main="UC m?re apicale, UC apicale",freq=FALSE,breaks=seq(2,23,1),xlim=c(2,23),ylim=c(0,0.5))
	points(dpois(x,mean(TA_apic_port_apic$NbFeu)),col=2,type='l')
hist(TA_apic_port_lat$NbFeu,main="UC m?re lat?rale, UC apicale",freq=FALSE,breaks=seq(2,23,1),xlim=c(2,23),ylim=c(0,0.5))
	points(dpois(x,mean(TA_apic_port_lat$NbFeu)),col=2,type='l')
hist(TA_lat_port_apic$NbFeu,main="UC m?re apicale, UC apicale",freq=FALSE,breaks=seq(2,23,1),xlim=c(2,23),ylim=c(0,0.5))
	points(dpois(x,mean(TA_lat_port_apic$NbFeu)),col=2,type='l')
hist(TA_lat_port_lat$NbFeu,main="UC m?re lat?rale, UC lat?rale",freq=FALSE,breaks=seq(2,23,1),xlim=c(2,23),ylim=c(0,0.5))
title("Nombre de feuilles issues d'une UC",outer=TRUE,line=-1)


# Arbre B12
par(mfrow=c(1,3))
hist(apic_B12_port_lat$NbFeu,main="UC m?re lat?rale",xlim=c(4,22),ylim=c(0,0.25),breaks=seq(3,19,1),xlab="Nombre de feuilles",freq=FALSE);
hist(apic_B12_port_apic$NbFeu,main="UC m?re apicale",xlim=c(4,22),ylim=c(0,0.25),breaks=seq(2,25,1),xlab="Nombre de feuilles",freq=FALSE);
...
hist(port_lat$NbFeu,main="en position lat?rale",freq=FALSE)
...
legend("topright",c("A","L"),lty=c(1,2),title="Position UC m?re")
...
x=2:25
par(mfrow=c(2,3))
hist(TA_apic_port_apic$NbFeu,main="UC m?re apicale, UC apicale",freq=FALSE,breaks=seq(2,23,1),xlim=c(2,25),ylim=c(0,0.22),xlab="Nombre de feuilles")
	points(dpois(x,mean(TA_apic_port_apic$NbFeu)),col=2,type='l')
legend("topleft","P(16.66)",col=2,lty=1,bty="n")
hist(TA_apic_port_lat$NbFeu,main="UC m?re lat?rale, UC apicale",freq=FALSE,breaks=seq(2,23,1),xlim=c(2,25),ylim=c(0,0.22),xlab="Nombre de feuilles")
	points(dpois(x,mean(TA_apic_port_lat$NbFeu)),col=2,type='l')
legend("topright","P(12.20)",col=2,lty=1,bty="n")
hist(TA_lat$NbFeu,main="UC m?re apicale, UC apicale",freq=FALSE,breaks=seq(2,23,1),xlim=c(2,25),ylim=c(0,0.22),xlab="Nombre de feuilles")
	points(dpois(x,mean(TA_lat$NbFeu)),col=2,type='l')
legend("topright","P(8.13)",col=2,lty=1,bty="n")

plot(ecdf(TA_apic_port_apic$NbFeu),main="UC m?re apicale, UC apicale",xlim=c(2,25))
	points(ppois(x,mean(TA_apic_port_apic$NbFeu)),col=2,type='l')
plot(ecdf(TA_apic_port_lat$NbFeu),main="UC m?re lat?rale, UC apicale",xlim=c(2,25))
	points(ppois(x,mean(TA_apic_port_lat$NbFeu)),col=2,type='l')
plot(ecdf(TA_lat$NbFeu),main="UC m?re apicale, UC apicale",xlim=c(2,25))
	points(ppois(x,mean(TA_lat$NbFeu)),col=2,type='l')
#title("Nombre de feuilles issues d'une UC",outer=TRUE,line=-1)

# Tests d'ad?quation ? la loi de Poisson
par(mfrow=c(1,3))
n=length(TA_apic_port_apic$NbFeu);lambda=mean(TA_apic_port_apic$NbFeu)
plot(qpois(c(1:n)/(n+1),lambda),quantile(TA_apic_port_apic$NbFeu,probs=c(1:n)/(n+1)),main="UC apicale de m?re apicale",xlab="n",ylab="n")
...
plot(qpois(c(1:n2)/(n2+1),lambda2),quantile(TA_apic_port_lat$NbFeu,probs=c(1:n2)/(n2+1)),main="UC apicale de m?re lat?rale",xlab="n",ylab="n")
...
plot(qpois(c(1:n3)/(n3+1),lambda3),quantile(TA_lat$NbFeu,probs=c(1:n3)/(n3+1)),main="UC lat?rale",xlab="n",ylab="n")
...
hist(MA_lat$NbFeu,main="UCs en position lat?rale",freq=FALSE,xlim=c(1,21),ylim=c(0,0.15),breaks=seq(1,18,1),xlab="Nombre de feuilles")
#title("Nombre de feuilles issues d'une UC ",outer=TRUE,line=-1)
...
hist(MA_lat$NbFeu,main="UCs en position lat?rale",freq=FALSE,xlim=c(0,25),ylim=c(0,0.15),breaks=seq(1,21,1),xlab="Nombre de feuilles");points(dpois(x,mean(MA_lat$NbFeu) ),type='l',col=2)
...
plot(ecdf(MA_lat$NbFeu),main="UCs en position lat?rale",xlim=c(0,25));
...
#plot(qpois(c(1:n)/(n+1),lambda),quantile(MA_apic$NbFeu,probs=c(1:n)/(n+1)),main="UC apicale de m?re apicale",xlab="n",ylab="n")
...
#plot(qpois(c(1:n2)/(n2+1),lambda2),quantile(MA_lat$NbFeu,probs=c(1:n2)/(n2+1)),main="UC apicale de m?re lat?rale",xlab="n",ylab="n")
...
hist(inf_lat$NbFeu,main="UCs en position lat?rale",freq=FALSE,xlim=c(3,22),ylim=c(0,0.28),breaks=seq(3,22,1),xlab="Nombre de feuilles")
#title("Nombre de feuilles issues d'une UC ",outer=TRUE,line=-1)
...
# UC en position lat?rale pour chaque arbre et en global
par(mfrow=c(2,3))
...
#title("Longueur des UCs en position lat?rale",outer=TRUE,line=-1)
...
# Tous les arbres r?unis 
par(mfrow=c(1,1))
hist(TA_apic$Long,main="Longueurs UCs apicales",freq=FALSE,ylim=c(0,0.25),xlim=c(6,25),breaks=seq(0,30,1),xlab="Longueur UC")
hist(TA_lat$Long,main="Longueurs UCs lat?rales",freq=FALSE,ylim=c(0,0.25),xlim=c(6,25),breaks=seq(0,30,1),xlab="Longueur UC")
...
# Histogramme 4 cas (apicale / lat?rale, pour UC et UC m?re)
par(mfrow=c(2,2))
hist(TA_apic_port_apic$Long,main="UC m?re apicale, UC apicale",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.2))
	curve(dnorm(x,mean(TA_apic_port_apic$Long),sd(TA_apic_port_apic$Long)),col=2,type='l',add=TRUE)
hist(TA_apic_port_lat$Long,main="UC m?re lat?rale, UC apicale",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.2))
	curve(dnorm(x,mean(TA_apic_port_lat$Long),sd(TA_apic_port_lat$Long)),col=2,type='l',add=TRUE)
hist(TA_lat_port_apic$Long,main="UC m?re apicale, UC apicale",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.2))
	curve(dnorm(x,mean(TA_lat_port_apic$Long),sd(TA_lat_port_apic$Long)),col=2,type='l',add=TRUE)
hist(TA_lat_port_lat$Long,main="UC m?re lat?rale, UC lat?rale",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.5))
...
# Arbre B12
par(mfrow=c(1,3))
hist(apic_B12_port_apic$Long,main="UC m?re apicale",freq=FALSE,xlim=c(5,25),ylim=c(0,0.2),breaks=seq(0,30,1),xlab="Longueur UC");
hist(apic_B12_port_lat$Long,main="UC m?re lat?rale",freq=FALSE,xlim=c(5,25),ylim=c(0,0.2),breaks=seq(0,30,1),xlab="Longueur UC");
...
hist(port_lat$Long,main="UCs porteuses en position lat?rale",freq=FALSE)


################ Analyses de variance

######## Effet position UC apicale / lat?rale
...
########## Effet position UC m?re apicale / lat?rale
...
par(mfrow=c(2,3))
hist(res_aov_apic[TA_aov_apic$TypAxePo=="T" ],main="Histogramme",freq=F,xlab="R?sidus des longueurs d'UC m?re apicale");curve(dnorm(x,0,sd(res_aov_apic)),col=2,add=T)
plot(ecdf(res_aov_apic[TA_aov_apic$TypAxePo=="T" ]),main="Fonction de r?partition");curve(pnorm(x,0,sd(res_aov_apic)),col=2,add=T)
qqnorm(res_aov_apic[TA_aov_apic$TypAxePo=="T" ],main="Droite de Henry");qqline(res_aov_apic[TA_aov_apic$TypAxePo=="T" ],col=2)

hist(res_aov_apic[TA_aov_apic$TypAxePo=="R" ],main="Histogramme",freq=F,xlab="R?sidus des longueurs d'UC m?re lat?rale");curve(dnorm(x,0,sd(res_aov_apic)),col=2,add=T)
plot(ecdf(res_aov_apic[TA_aov_apic$TypAxePo=="R" ]),main="Fonction de r?partition");curve(pnorm(x,0,sd(res_aov_apic)),col=2,add=T)
...
# test d'?galit? des variances (CN pour utilisation ANOVA)
...
# Histogramme 3 cas
par(mfrow=c(2,3))
hist(TA_apic_port_apic$Long,main="UC apicale de m?re apicale",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.15),xlab="Longueur UC")
	curve(dnorm(x,mean(TA_apic_port_apic$Long),sd(TA_apic_port_apic$Long)),col=2,type='l',add=TRUE)
legend("topleft",lty=1,col=2,"N(18.14,4.14)",bty="n")
hist(TA_apic_port_lat$Long,main="UC apicale de m?re lat?rale",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.15),xlab="Longueur UC")
	curve(dnorm(x,mean(TA_apic_port_lat$Long),sd(TA_apic_port_lat$Long)),col=2,type='l',add=TRUE)
legend("topright",lty=1,col=2,"N(13.79,4.03)",bty="n")
hist(TA_lat$Long,main="UC lat?rale",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.15),xlab="Longueur UC")
	curve(dnorm(x,mean(TA_lat_port_apic$Long),sd(TA_lat_port_apic$Long)),col=2,type='l',add=TRUE)
legend("topright",lty=1,col=2,"N(12.59,3.38)",bty="n")

plot(ecdf(TA_apic_port_apic$Long),main="UC apicale de m?re apicale")
	curve(pnorm(x,mean(TA_apic_port_apic$Long),sd(TA_apic_port_apic$Long)),col=2,type='l',add=TRUE)
plot(ecdf(TA_apic_port_lat$Long),main="UC apicale de m?re lat?rale")
	curve(pnorm(x,mean(TA_apic_port_lat$Long),sd(TA_apic_port_lat$Long)),col=2,type='l',add=TRUE)
plot(ecdf(TA_lat$Long),main="UC lat?rale")
	curve(pnorm(x,mean(TA_lat_port_apic$Long),sd(TA_lat_port_apic$Long)),col=2,type='l',add=TRUE)
#title("Longueur d'une UC",outer=TRUE,line=-1)

par(mfrow=c(1,3))
hist(TA_apic_port_apic$Long,main="Apical GU on apical mother",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.15),xlab="GU Length")
curve(dnorm(x,mean(TA_apic_port_apic$Long),sd(TA_apic_port_apic$Long)),col=2,type='l',add=TRUE)
legend("topleft",lty=1,col=2,"N(18.14,4.14)",bty="n")
hist(TA_apic_port_lat$Long,main="Apical GU on lateral mother",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.15),xlab="GU Length")
curve(dnorm(x,mean(TA_apic_port_lat$Long),sd(TA_apic_port_lat$Long)),col=2,type='l',add=TRUE)
legend("topright",lty=1,col=2,"N(13.79,4.03)",bty="n")
hist(TA_lat$Long,main="Lateral GU",freq=FALSE,breaks=seq(2,25,1),xlim=c(5.5,24.8),ylim=c(0,0.15),xlab="GU Length")
curve(dnorm(x,mean(TA_lat_port_apic$Long),sd(TA_lat_port_apic$Long)),col=2,type='l',add=TRUE)
legend("topright",lty=1,col=2,"N(12.59,3.38)",bty="n")

# Tests d'ad?quation ? la distribution
par(mfrow=c(1,3))
qqnorm(TA_apic_port_apic$Long,main="UCs apicales de m?re apicale");qqline(TA_apic_port_apic$Long,col=2)
qqnorm(TA_apic_port_lat$Long,main="UCs apicales de m?re lat?rale");qqline(TA_apic_port_lat$Long,col=2)
qqnorm(TA_lat$Long,main="UCs lat?rales");qqline(TA_lat$Long,col=2)
...
hist(MA_lat$Long,main="UCs en position lat?rale",freq=FALSE,breaks=seq(0,30,1),xlab="Longueur UC");#curve(dnorm(x,mean(MA_lat$Long),sd(MA_lat$Long)),add=TRUE,col=2)
#title("Longueur d'une UC ",outer=TRUE,line=-1)
...
hist(MA_lat$Long,main="UCs en position lat?rale",freq=FALSE,xlab="Longueur UC",breaks=seq(0,30,1));curve(dnorm(x,mean(MA_lat$Long),sd(MA_lat$Long)),add=TRUE,col=2)
...
plot(ecdf(MA_lat$Long),main="UCs en position lat?rale");curve(pnorm(x,mean(MA_lat$Long),sd(MA_lat$Long)),add=TRUE,col=2)

#title("Longueur d'une UC ",outer=TRUE,line=-1)

# Test d'ad?quation ? la distribution
#par(mfrow=c(1,2))
#qqnorm(MA_apic$Long,main="UCs apicales");qqline(MA_apic$Long,col=2)
#qqnorm(MA_lat$Long,main="UCs lat?rales");qqline(MA_lat$Long,col=2)
...
hist(inf_lat$Long,main="en position lat?rale",freq=FALSE,xlim=c(5,28),xlab="Longueur UC",ylim=c(0,0.18),breaks=seq(0,30,1));
#title("Longueur d'une UC ",outer=TRUE,line=-1)
...
###################################################################################
#############  Correspondance des diff?rents bases, Fusion, Estimation des lois  
##############################

##### Test  de correspondance des diff?rents bases 
...
legend("topright",c("Tayllamin","MA05","Inf?rence"),title="Base",lty=c(3,2,1))
axis(1, at = seq(2), labels = c("A","L"), tick = TRUE)
...
#########################################################################################
###########   Etude de la corr?lation entre le nombre de feuilles et la taille de l'UC  
#################################
...
plot(TA_lat$Long,TA_lat$NbFeu,abline(lsfit(TA_lat$Long,TA_lat$NbFeu),col=2),main="UCs lat?rales")
title("Etude de la corr?lation entre longueur d'UC et nbr de feuilles ",outer=TRUE,line=-1)
...
plot(MA_lat$Long,MA_lat$NbFeu,main="UCs lat?rales",ylim=c(3,22),xlab="Longueur",ylab="Nombre de feuilles")         # abline(lsfit(MA_lat$Long,MA_lat$NbFeu),col=2),
#title("Etude de la corr?lation entre longueur d'UC et nbr de feuilles ",outer=TRUE,line=-1)
...
plot(inf_lat$Long,inf_lat$NbFeu,abline(lsfit(inf_lat$Long,inf_lat$NbFeu),col=2),main="UCs lat?rales")
title("Etude de la corr?lation entre longueur d'UC et nbr de feuilles ",outer=TRUE,line=-1)
...
plot(TA_lat$Long,TA_lat$NbFeu,abline(lsfit(TA_lat$Long,TA_lat$NbFeu),col=2),main="UCs lat?rales",col=2)
points(MA_lat$Long,MA_lat$NbFeu,abline(lsfit(MA_lat$Long,MA_lat$NbFeu),col=3),main="UCs lat?rales",col=3)
points(inf_lat$Long,inf_lat$NbFeu,abline(lsfit(inf_lat$Long,inf_lat$NbFeu),col=4),main="UCs lat?rales",col=4)
...
plot(Long_lat,NbFeu_lat,abline(lsfit(Long_lat,NbFeu_lat),col=2),main="UCs lat?rales",xlim=c(5,26),ylim=c(0,26))
title("Etude de la corr?lation entre longueur d'UC et nbr de feuilles ",outer=TRUE,line=-1)
...
plot(Long_lat,NbFeu_lat,main="UCs lat?rales",xlim=c(5,26),ylim=c(0,26),xlab="Longueur UC",ylab="Nombre de feuilles")
abline(lat.lm,col=2)
...
legend("topleft",c("droite de r?gression", "IC moyenne","IC individu"),lty=c(1,2),col=c(2,4,6))


# Analyse de coVariance (test m?me intercept et m?me pente)
