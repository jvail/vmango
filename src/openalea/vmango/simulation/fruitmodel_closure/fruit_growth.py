...
from openalea.vmango.simulation.fruitmodel_closure.fruit_dry_matter_growth import growth_DM
from openalea.vmango.simulation.fruitmodel_closure.fruit_fresh_matter_growth import growth_FM
