...
fruitmodel = function(bloom_date, nb_fruits, nb_leaves, verbose=FALSE, MS_Init=NaN, k1_fruit_sample=NaN)
...
Res  = CROISSANCE_MF_TEMPERATURE (
                        ...
                        Jour_Flo = as.Date(bloom_date, "%d/%m/%Y"),
