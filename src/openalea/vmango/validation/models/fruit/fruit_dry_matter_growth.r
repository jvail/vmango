  ...
  
{
  ...
  dd_delta <- sum(((TN_air + TX_air)/2 - Tbase)/24)
  ...
  MR_stem <- MRR_stem/24 * (Q10_stem ^ ((TM_air - Tref)/10)) * (DM_structure_stem + reserve_stem / cc_stem)
  MR_leaf <- MRR_leaf * (Q10_leaf ^ ((TM_air - Tref)/10)) * (DM_structure_leaf + reserve_leaf / cc_leaf)
