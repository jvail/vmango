...
# Ce script sert � mettre en forme les donn�es pour qu'elles puissent �tre utilis�es dans le calcul de vraisemblance
# du mod�le stochastique des stades de d�veloppement (script Vraisemblance.R)
